...
// Removed TypeScript types and interfaces - using plain JavaScript

const sampleBudgetChallenge = {
...
const BudgetMasterChallenge = () => {
  ...
  const [output, setOutput] = useState(sampleBudgetChallenge)
  ...
  const generateChallenge = () => {
    ...
    setTimeout(() => {
      ...
      const budgetFormatted = formatCurrency(inputs.budget_limit, currency)
      const mockOutput = {
        ...
        required_items: [
          ...
          },
          {
            ...
            cost: `${formatCurrency(inputs.budget_limit * 0.1, currency)}`,
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleInputChange('scenario_type', e.target.value)
                  }
                  className="input-field"
                  required
                >
